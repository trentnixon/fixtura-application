...
import type { SeasonCompetitionCoverageSummarySectionProps } from "../_types";

export function SeasonCompetitionCoverageSummarySection({
  statGradeCount,
  statTeamCount,
  statFixtureCount,
}: SeasonCompetitionCoverageSummarySectionProps) {
  return (
