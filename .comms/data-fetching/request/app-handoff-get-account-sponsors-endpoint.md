...
**See also:** [app-handoff-account-sponsors-and-allocations-crud.md](./app-handoff-account-sponsors-and-allocations-crud.md) (create/update sponsors, upload logo, general vs entity allocations).
...
- **`sponsorshipAllocations`:** `{ id, allocation }[]` where **`allocation`** is the JSON from Strapi `Allocation` (may be `null`). Only **published** allocation rows are included.
