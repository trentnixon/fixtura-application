...
/**
 * BFF for GET /api/accounts/:accountId/organisation → Strapi org context slice (read-only).
 * @see .comms/data-fetching/handoff/handoff-phase-04-accounts-organisation.md
 */
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await fetch(`${strapiUrl}/api/accounts/${accountId}/organisation`, {
      headers: {
