...
/**
 * BFF for GET /api/accounts/:accountId/renders → Strapi paginated render list (Phase 7).
 * @see .comms/data-fetching/handoff/handoff-phase-07-renders-list.md
 */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await fetch(`${strapiUrl}/api/accounts/${accountId}/renders${search}`, {
      headers: {
