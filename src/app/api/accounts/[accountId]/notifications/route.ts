...
async function forwardNotificationsToStrapi(
  strapiUrl: string,
  accountId: string,
  token: string,
  init: RequestInit,
): Promise<Response> {
  return fetch(`${strapiUrl}/api/accounts/${accountId}/notifications`, {
    ...init,
    headers: {
...
/**
 * BFF for GET /api/accounts/:accountId/notifications → Strapi account notifications slice.
 * @see src/app/(members)/.comms/response/frontend-handoff-account-notifications.md
 */
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await forwardNotificationsToStrapi(strapiUrl, accountId, token, {
      method: "GET",
    });
...
/**
 * BFF for PATCH /api/accounts/:accountId/notifications → Strapi saveAccountNotifications.
 * @see src/app/(members)/.comms/response/frontend-handoff-account-notifications.md
 */
