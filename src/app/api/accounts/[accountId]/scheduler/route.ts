...
/**
 * BFF for GET /api/accounts/:accountId/scheduler → Strapi scheduler slice (read-only).
 * @see .comms/data-fetching/handoff/handoff-phase-05-accounts-scheduler.md
 */
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await fetch(`${strapiUrl}/api/accounts/${accountId}/scheduler`, {
      headers: {
