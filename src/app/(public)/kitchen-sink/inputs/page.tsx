    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="space-y-24">
        ...
        <Section spacing="none">
          <div className="mb-6">
            <h2 className="font-heading text-foreground text-xl font-semibold">Date Selection</h2>
          ...
          <GlassSurface className="border-primary/20 max-w-md">
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="space-y-1 text-center">
                <h4 className="font-heading font-bold italic">Verify Account</h4>
                ...
                <div className="space-y-4">
                  <div className="bg-muted/20 flex items-center justify-between rounded-xl border p-4">
                    <div className="space-y-0.5">
                      <p className="text-sm font-semibold">Enable Deep Scan</p>
                  ...
                  <div className="bg-muted/20 flex items-center justify-between rounded-xl border p-4">
                    <div className="space-y-0.5">
                      <p className="text-sm font-semibold">Public Log</p>
                      <p className="text-muted-foreground text-[10px]">
