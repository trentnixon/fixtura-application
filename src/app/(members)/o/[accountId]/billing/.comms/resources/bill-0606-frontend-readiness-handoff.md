...
| ------------------------------------------------------------ | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Billing UI reads from `GET /billing` (via BFF)               | Done   | [useAccountBilling.ts](../../../../../../../lib/api/hooks/account/useAccountBilling.ts), [billing-content.tsx](../../billing-content.tsx)                                                                                                          |
...
| Stripe Checkout return → refetch billing (+ related queries) | Done   | [billing-checkout-return.ts](../../billing-checkout-return.ts), [billing-content.tsx](../../billing-content.tsx)                                                                                                                                   |
