...
/**
 * BFF for POST /api/accounts/:accountId/billing/checkout/resume → Strapi.
 * @see src/app/(members)/o/[accountId]/billing/.comms/handoff/responses/cms-handoff-resume-stripe-checkout.md
 */
