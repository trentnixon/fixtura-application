...
import { buildSanitisedWeekendResultsDataset } from "../src/features/remotion-asset-preview/cricket-demo-manifest/generate-weekend-results-dataset";

const cwd = process.cwd();
const filePath = path.join(cwd, "public/dummyAssetData/Cricket/Cricket_WeekendResultsSingle.json");
...
const dataset = buildSanitisedWeekendResultsDataset({
  manifest,
