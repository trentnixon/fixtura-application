import { TypographyH1, TypographyH2, TypographyH3, TypographyMuted } from "@/components/typography";
  ...
  return (
    <div className="space-y-12">
      <header className="border-border border-b pb-6">
        <TypographyH1 className="text-3xl font-bold">Brand Colors</TypographyH1>
      ...
      <section>
        ...
        <div className="space-y-8">
          {Object.entries(colorScales).map(([name, scale]) => (
            <div key={name}>
              <TypographyH3 className="mb-3 text-base font-semibold capitalize">
                {name}
              </TypographyH3>
