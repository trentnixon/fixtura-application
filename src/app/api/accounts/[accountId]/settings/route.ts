...
/**
 * BFF for GET /api/accounts/:accountId/settings → Strapi account settings (read-only slice).
...
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await fetch(`${strapiUrl}/api/accounts/${accountId}/settings`, {
      headers: {
