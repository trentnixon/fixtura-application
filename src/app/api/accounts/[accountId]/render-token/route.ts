...
/**
 * BFF for GET /api/accounts/:accountId/render-token → Strapi render-token slice (read-only).
 * @see .comms/data-fetching/handoff/handoff-phase-06-accounts-render-token.md
 */
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const strapiRes = await fetch(`${strapiUrl}/api/accounts/${accountId}/render-token`, {
      headers: {
