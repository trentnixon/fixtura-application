...
import { getManageSponsorsEmptyStateAddHref } from "./_utils/manage-sponsors-empty-state-routes";
import { ManageSponsorsPageHelpTrigger } from "./manage-sponsors-page-help-trigger";
  ...
  return (
    <Card className="border-primary/15 bg-primary/5 shadow-sm ring-0">
      ...
      <CardFooter className="flex justify-center gap-2 px-6 pb-6">
        ...
        <ManageSponsorsPageHelpTrigger accountId={accountId} route="pool" variant="empty-state" />
      </CardFooter>
    </Card>
  );
}
